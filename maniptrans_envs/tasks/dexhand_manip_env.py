...
class DexHandManipEnv(DirectRLEnv):
    ...
    def _init_domain_randomization(self):
        ...
        try:
            ...
            mat_props[:, :, 0] = 2.0  # static friction (was 2.0, increased to compensate rolling/torsion)
            mat_props[:, :, 1] = 2.0  # dynamic friction (was 2.0, increased to compensate rolling/torsion)
