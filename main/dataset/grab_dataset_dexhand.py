...
class GrabDemoDexHand(ManipData):
    ...
    def __getitem__(self, idx):
        ...
        obj_mesh = trimesh.load(os.path.join(self.data_dir, "obj.obj"), process=False)
        ...
        rs_verts_obj = self.random_sampling_pc(obj_mesh)

        data = {
            "data_path": self.data_pathes[idx],
            "obj_id": "-1",  # ? placeholder
            "obj_verts": rs_verts_obj,
            "obj_urdf_path": os.path.join(self.data_dir, "obj.urdf"),
